...
import pandas as pd
import numpy as np
from ML.src.exception import customException
from ML.src.utils import load_object
from ML.src.components.data_transformationComponents import transformationFunctions
...
class PredictPipeline:
    ...
    def transformURL(self, url):
        """
        Transform the given URL into a format that can be used by the model.
        """
        try:
    ...
    def predict(self,features):
        """
        Predict the category of the given URL.
        """
        try:
